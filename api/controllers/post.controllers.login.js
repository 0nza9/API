...
module.exports = async (req, res, next) => {
  ...
  try {
    ...
    // Stockage sécurisé : cookie httpOnly. Les options (SameSite/Secure) sont
    // centralisées dans lib/cookie.js pour rester cohérentes avec /logout.
    res.cookie('token', token, { ...cookieOptions, maxAge: SESSION_TTL_MS })
